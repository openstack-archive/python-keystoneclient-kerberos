...
class TestKerberosAuth(base.TestCase):
    ...
    def test_authenticate_with_kerberos_domain_scoped(self):
        ...
        self.kerberos_mock.pass_resp['json'] = self.token_body
        self.kerberos_mock.pass_resp['headers'].update(headers)

        self.requests_mock.post(self.TEST_ROOT_URL + 'v3/auth/tokens',
                                response_list=self.kerberos_mock.resp_list)
